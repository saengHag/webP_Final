...
def find_key(keyword):
    ...
    if response.status_code == 200:
        ...
        print("HTTP 요청 실패")
    if __name__ == "__main__":
        return {"언론사": press, "제목": title, "작성일자": formatted_time, "링크": "https://news.google.com"+link}
