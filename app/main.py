...
def news_crawler():
    # 구글 뉴스 검색 URL
    url = "https://www.gamevu.co.kr/news/articleView.html?idxno=32810"      # URL 내에 query 변수명을 그대로 입력했더니 'query'라는 문자열을 검색한 결과가 나옴. 전에는 멀쩡했는데 왜 이러는지 모르겠음
    ...
    if response.status_code == 200:
        ...
        # 제목 추출
        title = soup.select_one('a.JtKRv')     # 클래스가 'JtKRv'인 a태그를 선택하고 내용 반환
